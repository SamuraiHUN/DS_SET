...
BYTE CDragonSoulTable::GetDSBasicApplyCount(BYTE iDSType)
{
	...
	return BYTE(it->second.vec_BasicApplys.size());
}
...
#endif
		{ "APPLY_ATTBONUS_METIN",			CItemData::APPLY_ATTBONUS_METIN},
		{ "APPLY_ATTBONUS_BOSSES",			CItemData::APPLY_ATTBONUS_BOSSES},
		{ "APPLY_RESIST_BOSSES",			CItemData::APPLY_RESIST_BOSSES},
		{ "APPLY_ENCHANT_ATTRIBUTES",		CItemData::APPLY_ENCHANT_ATTRIBUTES},
		{ "APPLY_CRITICAL_PVM_PCT",			CItemData::APPLY_CRITICAL_PVM_PCT},
		{ "APPLY_PENETRATE_PVM_PCT",		CItemData::APPLY_PENETRATE_PVM_PCT},
		{ "APPLY_PENETRATE_MAGIC_PCT",		CItemData::APPLY_PENETRATE_MAGIC_PCT},
		{ "APPLY_RESIST_HUMAN",				CItemData::APPLY_RESIST_HUMAN},
		{ "APPLY_STEAL_HP_PVM",				CItemData::APPLY_STEAL_HP_PVM},
		{ "APPLY_RUPTURE_SWORD",			CItemData::APPLY_RUPTURE_SWORD},
		{ "APPLY_RUPTURE_TWOHAND",			CItemData::APPLY_RUPTURE_TWOHAND},
		{ "APPLY_RUPTURE_DAGGER",			CItemData::APPLY_RUPTURE_DAGGER},
		{ "APPLY_RUPTURE_BELL",				CItemData::APPLY_RUPTURE_BELL},
		{ "APPLY_RUPTURE_FAN",				CItemData::APPLY_RUPTURE_FAN},
		{ "APPLY_RUPTURE_BOW",				CItemData::APPLY_RUPTURE_BOW},
		{ "APPLY_RUPTURE_BLOCK",			CItemData::APPLY_RUPTURE_BLOCK},
		{ "APPLY_RUPTURE_REFLECT",			CItemData::APPLY_RUPTURE_REFLECT},
		{ "APPLY_RUPTURE_DODGE",			CItemData::APPLY_RUPTURE_DODGE},
		{ "APPLY_RESIST_CRITIAL_HITS",		CItemData::APPLY_RESIST_CRITIAL_HITS},
		{ "APPLY_RESIST_PENETRATE_HITS",	CItemData::APPLY_RESIST_PENETRATE_HITS},
		{ "APPLY_ATTGENERAL_SPEED",			CItemData::APPLY_ATTGENERAL_SPEED},
	};
